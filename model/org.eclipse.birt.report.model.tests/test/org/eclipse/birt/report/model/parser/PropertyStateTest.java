...
public class PropertyStateTest extends BaseTestCase
{
	...
	public void testEmptyString( ) throws Exception
	{
		...
		dataSourceHandle = (OdaDataSourceHandle) designHandle
		...
		assertEquals(
				"html", designHandle.getStringProperty( ReportDesign.DESCRIPTION_PROP ) ); //$NON-NLS-1$
		designHandle.setStringProperty( ReportDesign.DESCRIPTION_PROP,
				"   <p> html </p>   " ); //$NON-NLS-1$
		assertEquals(
				"<p> html </p>", designHandle.getStringProperty( ReportDesign.DESCRIPTION_PROP ) ); //$NON-NLS-1$
	...
	public void testWrongPropertyNameInTextProperty( )
			throws DesignFileException
	{
	...
	public void testBlankResourceKeyValueInTextProperty( )
			throws DesignFileException
	{
	...
	/**
	 * Tests the parser can recover
	 * <code>DESIGN_EXCEPTION_NON_POSITIVE_VALUE</code> and
	 * <code>DESIGN_EXCEPTION_NEGATIVE_VALUE</code>. This applies to both
