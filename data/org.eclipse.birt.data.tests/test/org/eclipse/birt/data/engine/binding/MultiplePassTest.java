...
public class MultiplePassTest extends APITestCase
{
	...
	public void testTopBottomN( ) throws Exception
	{
		...
		IBaseExpression[] expressions = new IBaseExpression[]{
				new ScriptExpression( "row.ROW_0", 0 ),
				new ScriptExpression( "row.ROW_rowPosition ", 0 ),
		...
		FilterDefinition[] filters = new FilterDefinition[]{
				...
				new FilterDefinition( new ConditionalExpression("row.FILTER_AMOUNT",IConditionalExpression.OP_BOTTOM_N,"6")),
				new FilterDefinition( new ConditionalExpression("row.FILTER_COUNTRY",IConditionalExpression.OP_BOTTOM_N,"5")),
				new FilterDefinition( new ConditionalExpression("row.FILTER_SALE_DATE",IConditionalExpression.OP_TOP_N,"3"))};
	...
	private void createAndRunQuery(String[] bindingNameGroup,
			IBaseExpression[] bindingExprGroup, String[] bindingNameSort,
			IBaseExpression[] bindingExprSort, String[] bindingNameFilter,
			IBaseExpression[] bindingExprFilter, String[] bindingNameRow,
			IBaseExpression[] bindingExprRow, IBaseExpression[] expressions,
			GroupDefinition[] groupDefn, SortDefinition[] sortDefn,
			FilterDefinition[] filters) throws Exception, IOException
	{
		QueryDefinition queryDefn = createQueryDefn(bindingNameRow, expressions, groupDefn,
				sortDefn, filters);

		createAndRunQuery(bindingNameGroup, bindingExprGroup, bindingNameSort,
				bindingExprSort, bindingNameFilter, bindingExprFilter,
				bindingNameRow, bindingExprRow, expressions, queryDefn);
	}
	...
	private void populateBindings( QueryDefinition queryDefn, String[] name, IBaseExpression[] expr )
	{
		if( name!= null && expr!= null)
		{
			for ( int i = 0; i < name.length; i++)
				queryDefn.addResultSetExpression(name[i],
						expr[i]);
		}
	}
	/**
	...
	public void testTopBottomPercent( ) throws Exception
	{
		...
		FilterDefinition[] filters = new FilterDefinition[]{
				new FilterDefinition( new ConditionalExpression("row.FILTER_AMOUNT",IConditionalExpression.OP_BOTTOM_PERCENT,"75")),
				new FilterDefinition( new ConditionalExpression("row.FILTER_COUNTRY",IConditionalExpression.OP_BOTTOM_N,"5")),
				new FilterDefinition( new ConditionalExpression("row.FILTER_SALE_DATE",IConditionalExpression.OP_TOP_PERCENT,"60"))};
	...
	public void testTopBottmPercentWithOtherFilters( ) throws Exception
	{
		...
		FilterDefinition[] filters = new FilterDefinition[]{
				new FilterDefinition( new ConditionalExpression("row.FILTER_AMOUNT",IConditionalExpression.OP_BOTTOM_PERCENT,"100")),
			 	new FilterDefinition( new ConditionalExpression("row.FILTER_AMOUNT",IConditionalExpression.OP_GT,"100")),
				new FilterDefinition( new ConditionalExpression("row.FILTER_COUNTRY",IConditionalExpression.OP_BOTTOM_PERCENT,"75")),
				new FilterDefinition( new ConditionalExpression("row.FILTER_AMOUNT",IConditionalExpression.OP_GT,"400"))};
	...
	public void testInvalidFilter( ) throws Exception
	{
		...
		FilterDefinition[] filters = new FilterDefinition[]{
				new FilterDefinition( new ConditionalExpression("row.FILTER_AMOUNT",IConditionalExpression.OP_TOP_N,"-1"))};
		...
		filters = new FilterDefinition[]{
				new FilterDefinition( new ConditionalExpression("row.FILTER_AMOUNT",IConditionalExpression.OP_TOP_N,"abc"))};
		try{
			createAndRunQuery(bindingNameGroup, bindingExprGroup, bindingNameSort,
					bindingExprSort, bindingNameFilter, bindingExprFilter,
					bindingNameRow, bindingExprRow, expressions, groupDefn, sortDefn, filters);
	...
	public void testGroupFiltering( ) throws Exception
	{
		...
		groupDefn[0]
				.setKeyExpression("row.GROUP_GROUP0");
		...
		createAndRunQuery(bindingNameGroup, bindingExprGroup, bindingNameSort,
				bindingExprSort, bindingNameFilter, bindingExprFilter,
				bindingNameRow, bindingExprRow, expressions, groupDefn, null, null);
	}
	...
	public void testGroupSorting( ) throws Exception
	{
		...
		sortDefn
				.setExpression("Total.sum(dataSetRow.AMOUNT,Total.NO_FILTER,Total.CURRENT_GROUP)");
		//desc
		sortDefn.setSortDirection( 0 );
	...
	public void testGroupFilteringSorting2( ) throws Exception
	{
		...
		FilterDefinition filterDefn = new FilterDefinition(
				new ConditionalExpression("row.FILTER_1",
		...
		filterDefn = new FilterDefinition(new ConditionalExpression(
				"row.FILTER_2",
	...
	public void testMixedFiltering() throws Exception
	{
		...
		FilterDefinition[] filters = new FilterDefinition[]{
				new FilterDefinition( new ConditionalExpression("row.FILTER_1",IConditionalExpression.OP_BOTTOM_N,"7")),
	...
	public void testIndirectNestedTotal() throws Exception
	{
		...
		IBaseExpression[] expressions = new IBaseExpression[]{
				...
				new ScriptExpression( "row.ROW_SALE_DATE", 0 ),
				new ScriptExpression( "row.ROW_AMOUNT", 0 ),
				new ScriptExpression( "row.ROW_TOPN",0)
		};
	...
	public void testNestedTotal() throws IOException, Exception
	{
		...
		bindingExprRow[10] = new ScriptExpression( "Total.sum(Total.sum(Total.sum(dataSetRow.AMOUNT,null,2),null,1)+dataSetRow.AMOUNT)");//44500
		bindingExprRow[11] = new ScriptExpression( "Total.sum(Total.sum(Total.sum(dataSetRow.AMOUNT,null,2)+dataSetRow.AMOUNT,null,1))");//26700
		...
		createAndRunQuery(null, null,null,
				null, null,null,
				bindingNameRow, bindingExprRow, null, groupDefn, null, null);
	}
	...
	public void testNestedTotal1() throws IOException, Exception
	{
		...
		bindingExprRow[10] = new ScriptExpression( "Total.sum(Total.sum(Total.sum(dataSetRow.AMOUNT,null,2))+dataSetRow.AMOUNT,null,0)");//44500
	...
	public void testNestedTotal2() throws IOException, Exception
	{
		...
		bindingExprRow[6] = new ScriptExpression( "Total.sum(Total.sum(dataSetRow.AMOUNT),Total.sum(dataSetRow.AMOUNT)>2000,0)");//8900
		bindingExprRow[6].setGroupName( "group0" );
		bindingExprRow[7] = new ScriptExpression( "Total.sum(Total.sum(Total.sum(dataSetRow.AMOUNT, dataSetRow.AMOUNT>400),null,1),null,0)");//8900
		bindingExprRow[7].setGroupName( "group1" );
		bindingExprRow[8] = new ScriptExpression( "Total.sum(Total.sum(Total.sum(dataSetRow.AMOUNT,dataSetRow.AMOUNT>100,2)),null,0)");//8904
		bindingExprRow[8].setGroupName( "group0" );
		/////////////////PROBLEM//////////////////
		bindingExprRow[9] = new ScriptExpression( "Total.sum(Total.sum(Total.sum(dataSetRow.AMOUNT,null,2),Total.sum(dataSetRow.AMOUNT,null,2)>1,1),null,0)");//8902
		///////////////////////////////////////////
		bindingExprRow[9].setGroupName( "group0" );
		bindingExprRow[10] = new ScriptExpression( "Total.sum(Total.sum(Total.sum(dataSetRow.AMOUNT,null,2))+dataSetRow.AMOUNT,null,0)");//44500
		bindingExprRow[10].setGroupName( "group0" );
		bindingExprRow[11] = new ScriptExpression( "Total.sum(Total.sum(Total.sum(dataSetRow.AMOUNT,null,2),null,1),Total.sum(Total.sum(dataSetRow.AMOUNT,null,2),null,1)>7000,0)");//26700
		bindingExprRow[12] = new ScriptExpression( "Total.sum(Total.sum(Total.sum(dataSetRow.AMOUNT,null,2),null,1)+row.ROW_AMOUNT)");
		bindingExprRow[13] = new ScriptExpression( "Total.sum(Total.sum(Total.sum(dataSetRow.AMOUNT,null,2)+row.ROW_AMOUNT,null,1))");
		bindingExprRow[14] = new ScriptExpression( "Total.sum(dataSetRow.AMOUNT/Total.sum(dataSetRow.AMOUNT,null,1))");
		bindingExprRow[15] = new ScriptExpression( "Total.sum(row.ROW_AMOUNT/Total.sum(dataSetRow.AMOUNT),null,0)");
	...
	public void testNestedTotal3() throws IOException, Exception
	{
		...
		bindingExprRow[3] = new ScriptExpression( "dataSetRow.AMOUNT" );
		/////////////////PROBLEM//////////////////
		bindingExprRow[4] = new ScriptExpression( "Total.sum(Total.sum(Total.sum(dataSetRow.AMOUNT,null,2),null,1),Total.sum(Total.sum(dataSetRow.AMOUNT,null,2),null,1)>7000,0)");//8902
		///////////////////////////////////////////
		// --- end binding
	...
	public void testMixedMultipassFilting() throws Exception
	{
		...
		FilterDefinition[] filters = new FilterDefinition[]{
				new FilterDefinition( new ConditionalExpression("row.FILTER_1",IConditionalExpression.OP_BOTTOM_N,"7")),
			 	new FilterDefinition( new ConditionalExpression("row.FILTER_2",IConditionalExpression.OP_LT,"700")),
			 	new FilterDefinition( new ConditionalExpression("Total.isTopN(dataSetRow.AMOUNT,1,null,1)",IConditionalExpression.OP_TRUE))};
	...
	public void testTop_Bottom_FilteringInGroupInstance_1() throws Exception
	{
		...
		FilterDefinition[] filters = new FilterDefinition[]{
				new FilterDefinition( new ConditionalExpression("Total.isTopN(row.ROW_AMOUNT,3,null,1)",IConditionalExpression.OP_TRUE))
		};
	...
	public void testTop_Bottom_FilteringInGroupInstance_2() throws Exception
	{
		...
		FilterDefinition[] filters = new FilterDefinition[]{
				new FilterDefinition( new ConditionalExpression("Total.isTopN(dataSetRow.AMOUNT,3,null,1)",IConditionalExpression.OP_TRUE)),
				new FilterDefinition( new ConditionalExpression("Total.isBottomN(dataSetRow.AMOUNT,2,null,2)",IConditionalExpression.OP_TRUE)),
				new FilterDefinition( new ConditionalExpression("dataSetRow.CITY",IConditionalExpression.OP_NE,"\"Chicago\""))
		};
	...
	public void testMultipassWithAlias( ) throws Exception
	{
		...
		FilterDefinition[] filters = new FilterDefinition[]{
				new FilterDefinition( new ConditionalExpression("row.FILTER_1",IConditionalExpression.OP_BOTTOM_N,"7")),
			 	new FilterDefinition( new ConditionalExpression("row.FILTER_2",IConditionalExpression.OP_LT,"700")),
			 	new FilterDefinition( new ConditionalExpression("Total.isTopN(dataSetRow.A,1,null,1)",IConditionalExpression.OP_TRUE))};
